        ...
        <div className="flex flex-col items-center gap-8">
          <div className="relative">
            ...
            <img 
              src="/logo.png" 
              alt="Loading..." 
              className="w-24 h-24 object-contain animate-bounce drop-shadow-[0_0_20px_rgba(34,211,238,0.4)] relative z-10" 
            />
          </div>
          <div className="flex flex-col items-center gap-2">
            <span className="font-black tracking-[0.6em] uppercase text-[10px] text-cyan-500 animate-pulse">Initializing Deck</span>
            <div className="w-48 h-1 bg-gray-900 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-cyan-500 to-indigo-500 w-1/3 animate-[loading_2s_infinite]"></div>
            </div>
          </div>
        </div>
      </div>
